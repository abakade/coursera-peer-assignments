...
circle = folium.Circle(nasa_coordinate, radius=1000, color= '#00BFFF', fill=True).add_child(folium.Popup('NASA JSC'))
...
marker = folium.map.Marker(
    ...
    icon=DivIcon(
        icon_size=(20,20),
        icon_anchor=(0,0),
        html='<div style="font-size: 12; color:#FF1493;"><b>%s</b></div>' % 'NASA JSC'
        )
    )
